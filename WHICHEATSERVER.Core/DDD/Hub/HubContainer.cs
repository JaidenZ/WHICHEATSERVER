namespace WHICHEATSERVER.Core.DDD.Hub
{
    ...
    public static class HubContainer
    {
        ...
        /// IList<Binding>
        /// </summary>
        private static IDictionary<int, IDictionary<int, IDictionary<int, IDictionary<string, IDictionary<string, IDictionary<string, object>>>>>> m_bindings = new Dictionary<int, IDictionary<int, IDictionary<int, IDictionary<string, IDictionary<string, IDictionary<string, object>>>>>>(300);
