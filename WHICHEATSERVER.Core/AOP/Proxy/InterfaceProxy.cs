namespace WHICHEATSERVER.Core.AOP.Proxy
{
    using System;
    ...
    /// 动态接口代理
    /// </summary>
    public sealed partial class InterfaceProxy
    {
        private class Map
        {
            public Type New
    ...
    public partial class InterfaceProxy
    {
        public static MethodBase GetMethod(object obj, int rid)
        {
            if (obj == null)
            {
                throw new ArgumentNullException();
            }
            Type[] clazz = (obj.GetType()).GetInterfaces();
            if (clazz.Length <= 0)
            {
                throw new ArgumentException();
            }
            Module module = clazz[0].Module;
            return module.ResolveMethod(rid);
        }

        public static object Invoke(object obj, MethodBase method, params object[] args)
        {
        ...
        public static object Invoke(object obj, int rid, params object[] args)
        {
            var met = InterfaceProxy.GetMethod(obj, rid);
