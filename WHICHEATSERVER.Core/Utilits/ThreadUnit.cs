namespace WHICHEATSERVER.Core.Utilits
{
    ...
    public static class ThreadUnit
    {
        ...
        public static object GetObject()
        {
            ...
            return ThreadUnit.GetObject(g_pThread);
        }

        public static T GetObject<T>(this Thread key)
        {
            object g_pState = ThreadUnit.GetObject(key);
            if (g_pState == null)
            {
                return default(T);
            }
        ...
        {
            Thread g_pThread = Thread.CurrentThread;
            return ThreadUnit.GetObject<T>(g_pThread);
        }
        ...
        public static object GetObject(this Thread key)
        {
            ...
            lock (g_pLookGetObj)
            {
                if (g_pGetObject == null)
                {
                    ...
                    FieldInfo g_pField = ThreadUnit.GetObjectField();
        ...
        {
            Thread g_pThread = Thread.CurrentThread;
            ThreadUnit.SetObject(g_pThread, value);
        }
